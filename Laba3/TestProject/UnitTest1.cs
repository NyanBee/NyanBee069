...
namespace TestProject
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void TestMethod2() //проверка на максимум
        {
        ...
        [TestMethod]
        public void TestMethod3() //проверка на минимум
        {
        ...
        [TestMethod]
        public void TestMethod4()//проверка на среднее
        {
            MyInt dde = new MyInt(-100);
        ...
        [TestMethod]
        public void TestMethod7()//тест сравнение 20==20
        {
        ...
        [TestMethod]
        public void TestMethod8() // тест сложение (100+566=666)
        {
            MyInt dde = new MyInt(100);
            MyInt tdd = new MyInt(566);
            MyInt answer = new MyInt(666);
